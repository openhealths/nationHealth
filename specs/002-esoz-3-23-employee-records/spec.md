...
| **FR-GAP-323-DOC-SERIES** | 3.23.1.3.2 | ~~Low~~ **REVERTED / WAIVED** | Single «Серія/номер документа» field kept (UX preference); format still validated by `DocumentNumber` rule |
