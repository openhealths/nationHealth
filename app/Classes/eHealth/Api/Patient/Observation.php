...
class Observation extends PatientApiBase
{
    ...
    protected function observationValidationRules(): array
    {
        return ValidationRuleBuilder::merge(
            ...
            // Observation value
            [
                'value_quantity' => ['nullable', 'array'],
                'value_quantity.value' => ['nullable'],
                'value_quantity.comparator' => ['nullable', 'string', 'max:255'],
                'value_quantity.unit' => ['nullable', 'string', 'max:255'],
                'value_quantity.system' => ['nullable', 'string', 'max:255'],
                'value_quantity.code' => ['nullable', 'string', 'max:255'],
                'value_string' => ['nullable', 'string'],
                'value_boolean' => ['nullable', 'boolean'],
                'value_date_time' => ['nullable', 'date'],
                'value_time' => ['nullable', 'string', 'max:255'],
                'value_range' => ['nullable', 'array'],
                'value_ratio' => ['nullable', 'array'],
                'value_sampled_data' => ['nullable', 'array'],
            ],
            ValidationRuleBuilder::codeableConceptRules('value_codeable_concept'),
            ...
            [
                ...
                'components.*.value_quantity.value' => ['nullable'],
                'components.*.value_quantity.comparator' => ['nullable', 'string', 'max:255'],
                'components.*.value_quantity.unit' => ['nullable', 'string', 'max:255'],
                'components.*.value_quantity.system' => ['nullable', 'string', 'max:255'],
                'components.*.value_quantity.code' => ['nullable', 'string', 'max:255'],
                'components.*.value_string' => ['nullable', 'string'],
                'components.*.value_boolean' => ['nullable', 'boolean'],
                'components.*.value_date_time' => ['nullable', 'date'],
                'components.*.value_time' => ['nullable', 'string', 'max:255'],
                'components.*.value_range' => ['nullable', 'array'],
                'components.*.value_ratio' => ['nullable', 'array'],
                'components.*.value_sampled_data' => ['nullable', 'array'],
