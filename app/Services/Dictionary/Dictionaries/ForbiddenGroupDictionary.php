...
class ForbiddenGroupDictionary implements DictionaryInterface
{
    /**
     * Dictionary unique identifier key.
     */
    public const string KEY = 'dictionaries.forbidden_group';
    ...
    public function fetch(int $page = 1): EHealthResponse
    {
        ...
        return EHealth::forbiddenGroup()->getMany($params);
    }
}
