...
namespace App\Livewire\CarePlan\Activity\Cancel;
...
class CarePlanActivityCancel extends CarePlanComponent
{
    ...
    public function mount(CarePlan $carePlan, CarePlanActivity $activity): void
    {
        ...
        $this->openSignatureModal('cancel_activity', $activity->id);
    }

    protected function renderCarePlan()
    {
        return view('livewire.care-plan.activity.cancel.care-plan-activity-cancel');
    }
}
