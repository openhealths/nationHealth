...
class CompositionTempDisabilityForm extends BaseForm
{
    ...
    public function compositionRules(array $allowedCategories = [], array $allowedTreatmentViolations = []): array
    {
        return [
            ...
            // UI uses app date format (dd.mm.yyyy); mapper converts to Y-m-d.
    ...
    public function toMapperData(): array
    {
        return [
            ...
            'eventPeriodStart' => convertToYmd($this->eventPeriodStart),
            'eventPeriodEnd' => convertToYmd($this->eventPeriodEnd),
            ...
            'treatmentViolationDate' => filled($this->treatmentViolationDate)
                ? convertToYmd((string) $this->treatmentViolationDate)
                : null,
