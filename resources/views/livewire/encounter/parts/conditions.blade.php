                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 items-end">
                                        <div>
                                            <template x-if="bsIndex === 0">
                                                <label
                                                    class="text-xs text-gray-500 dark:text-gray-400 font-medium block mb-1">{{ __('patients.body_part') }}</label>
                                            </template>
                                            <div class="relative">
                        ...
                        <div x-show="modalCondition.primarySource === true" class="mt-8 transition-all">
                            <div class="form-group group">
                                <label for="doctorComment"
                                       class="text-sm font-bold text-gray-900 dark:text-white block mb-3">{{ __('forms.comment') }}</label>
                                <textarea rows="4"
                                          x-model="modalCondition.asserterText"
                                          id="doctorComment"
                                          name="doctorComment"
