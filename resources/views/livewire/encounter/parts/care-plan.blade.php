<div class="overflow-x-auto relative" id="care-plan-section">
    <fieldset class="fieldset">
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('care-plan.create', [legalEntity(), 'patientUuid' => $patientUuid, 'encounterUuid' => $form->encounter['uuid'] ?? '', 'conditionUuid' => $primaryConditionUuid ?? '']) }}"
            ...
            <table class="table-input w-inherit">
                ...
                @foreach($linkedCarePlans as $plan)
                    <tr>
                        ...
                        <td class="td-input">
                                <span
                                    class="badge {{ in_array($plan->status, ['ACTIVE', 'active']) ? 'badge-success' : 'badge-secondary' }}">
