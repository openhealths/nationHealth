        ...
        <ul class="space-y-2">
            ...
            @if(legalEntity())
                ...
                @endcan
                    ...
                    <li x-data="{ open: {{ (request()->routeIs('dictionary.programs-medications.index') || request()->routeIs('dictionary.programs-services.index')) ? 'true' : 'false' }} }"
                        class="space-y-2">
                        <button @click="open = !open"
                                type="button"
                                class="menu-item"
                        ...
                        >
                            ...
                            <li>
                                <a href="{{ route('dictionary.programs-services.index', [legalEntity()]) }}"
                                   class="submenu-item"
                                >
                                    @icon('boxicons_file')
