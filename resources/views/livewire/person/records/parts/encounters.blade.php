    ...
    <div class="record-inner-card">
        <div class="record-inner-header">
            ...
            <div class="record-inner-column flex-1">
                ...
                <div class="record-inner-value text-[20px] font-semibold">{{ $encounter['period']['start'] }}</div>
            </div>
            ...
            <div class="record-inner-column-bordered w-full md:w-36 shrink-0">
                ...
                <div>
                    <span class="record-inner-status-badge">
                        {{ EncounterStatus::from($encounter['status'])->label() }}
                    </span>
                </div>
            </div>
        ...
        <div class="record-inner-body">
                ...
                <div class="flex items-start justify-between gap-2 xl:gap-4 overflow-hidden">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="record-inner-value truncate">
                            {{ $this->dictionaries['eHealth/encounter_classes'][$encounter['class']['code']] }}
                        </div>
                    </div>
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="record-inner-value truncate">
                            {{ $this->dictionaries['eHealth/encounter_types'][$encounter['type']['coding'][0]['code']] }}
                        </div>
                    </div>
            ...
            <div class="record-inner-id-col">
                ...
                <div class="min-w-0">
                    ...
                    <div class="record-inner-id-value">{{ $encounter['episode']['identifier']['value'] }}</div>
                </div>
            </div>
        </div>
    </div>
