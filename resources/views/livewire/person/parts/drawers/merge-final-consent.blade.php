...
>
    <x-slot name="title">
        {{ __('patients.merge.consent_form_title') }}
    </x-slot>
    ...
    <div class="mt-8 space-y-6">
        <div class="space-y-3.5">
            <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800/40 border border-gray-100 dark:border-gray-700/50 text-sm text-gray-700 dark:text-gray-300">
                {{ __('patients.merge.consent_step_1') }}
            </div>
            <div>
                <button type="button"
                ...
                >
                    ...
                    <span>{{ __('patients.merge.print_consent_form') }}</span>
                </button>
            </div>
        </div>
        ...
        <div class="space-y-4">
            <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800/40 border border-gray-100 dark:border-gray-700/50 text-sm text-gray-700 dark:text-gray-300">
                {{ __('patients.merge.consent_step_2') }}
            </div>
            ...
            <div class="flex items-start">
                ...
                <label for="consentSigned" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 cursor-pointer select-none">
                    {{ __('patients.merge.consent_form_signed_checkbox') }}
                </label>
            </div>
        </div>
