<section class="section-form px-4 py-8">
    <x-header-navigation class="breadcrumb-form mb-6">
        <x-slot name="title">{{ __('care-plan.new_prescription') }}</x-slot>
    </x-header-navigation>
    ...
    >
        <div class="flex gap-4 mb-6">
            <a href="{{ route('care-plans.show', [legalEntity(), $carePlan->id]) }}" class="button-minor" wire:navigate>{{ __('forms.back') }}</a>
        </div>
