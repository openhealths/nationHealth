    ...
    >
        ...
        <table class="table-input w-inherit">
            ...
            <tr>
                ...
                <th scope="col" class="th-input">{{ __('forms.issued_date') }}</th>
                            ...
                            <form>
                                <div class="form-row-modal">
                                    ...
                                    <div class="relative">
                                        ...
                                        <label for="educationIssuedDate" class="label-modal">{{ __('forms.issued_date') }}<span class="text-red-600"> *</span></label>
