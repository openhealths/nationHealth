...
return [
    ...
    */
    ...
    'confirmation_of_simplified_declaration_registration' => 'Укладання декларації за спрощеною схемою',
    ...
    'patient_confirm_sync_message' => 'пацієнта проінформовано про необхідність синхронізації його персональних даних',
    ...
    'informed_about_data_processing' => 'підтверджуєте, що повідомили пацієнту або його законному представнику мету та підстави обробки його персональних даних.',
